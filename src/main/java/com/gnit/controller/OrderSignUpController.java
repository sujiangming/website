...
@Controller
@RequestMapping(value = "orderSignUp")
public class OrderSignUpController {
	...
	public @ResponseBody String selectList(@RequestParam Map<String, Object> para, HttpServletRequest request,
		...
		PageList<OrderSignUp> list = orderSignUpService.selectList(parameter);
	...
	public @ResponseBody String saveOrUpdate(@RequestParam Map<String, Object> para, HttpServletRequest arg0,
		...
		OrderSignUp sa = orderSignUpService.findObjectById(id);
		if (sa != null) {
