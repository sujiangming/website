...
<script type="text/javascript"
	src="${ContextPath}/pages/news/industry/indnews.js"></script>
<style type="text/css">
		...
		<div class="modal fade" id="myModal1" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog" style="width: 800px">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="form-group form-group-sm ">
							<label class="col-sm-2 control-label"><span
								style="color: red; position: relative; top: 2px;">*</span>新闻标题</label>
							<div class="col-sm-6">
								<input class="form-control validate[required]" id="newsTitle"
									type="text" />
							</div>
						</div>
						<br>
						<div class="form-group form-group-sm ">
							<label class="col-sm-2 control-label"><span
								style="color: red; position: relative; top: 2px;">*</span>新闻内容</label>
						</div>
						<br>
					...
					<input class="form-control" id="newsId"
						name="${loginUser.userName}" type="hidden" />
				</div>
			</div>
		</div>
		<!-- 弹出窗口区域，触发事件后弹出   结束 -->
