...
<script type="text/javascript"
	src="${ContextPath}/pages/consult/ordersign/consult.js"></script>
<style type="text/css">
						...
						<form id="myForm1" class="form-horizontal" role="form">
							<fieldset id="customerInfo">
								...
								<div class="form-group form-group-sm ">
									...
									<div class="col-sm-6">
										<input class="form-control validate[required]" id="userName"
											type="text" />
									</div>
								</div>
								<div class="form-group form-group-sm ">
								...
								<div class="form-group form-group-sm ">
									<label class="col-sm-2 control-label"><span
										...
										关注课程</label>
									<div class="col-sm-6">
										<input class="form-control validate[required]" id="courseName"
											type="text" />
									</div>
								</div>
								<div class="form-group form-group-sm ">
